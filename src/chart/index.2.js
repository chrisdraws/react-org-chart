...
function init(options) {
  ...
  var marginNew = { top: 20, right: 90, bottom: 30, left: 90 },
    width = 960 - marginNew.left - marginNew.right,
    height = 500 - marginNew.top - marginNew.bottom;
  ...
  var svg = d3
    .select(id)
    .append("svg")
    .attr("width", width + marginNew.right + marginNew.left)
    .attr("height", height + marginNew.top + marginNew.bottom)
    .append("g")
    .attr(
      "transform",
      "translate(" + marginNew.left + "," + marginNew.top + ")"
    );
